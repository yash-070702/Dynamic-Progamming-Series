...
public:
    ...
    // int solve(int ind , vector<int>&startTime,vector<int>& endTime, vector<int>& profit,int nextStart , int n){
    //     if(ind==n)
    //     return 0;

    //     int include=0;
    //     if(nextStart<=startTime[ind])
    //     include=profit[ind]+solve(ind+1,startTime,endTime,profit,endTime[ind],n);

    //     int exclude=solve(ind+1,startTime,endTime,profit,nextStart,n);
    ...
    // return solve(0,startTime,endTime,profit,nextStart,n);
    // }
